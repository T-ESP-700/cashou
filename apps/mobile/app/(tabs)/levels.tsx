...
export default function LevelsScreen() {
  ...
  if (isLoading) {
    return (
      <View style={[styles.container, { backgroundColor: theme.background }]}>
        <View style={styles.centered}>
          <ActivityIndicator size="large" color={theme.accent} />
          <Text style={[styles.loadingText, { color: theme.text }]}>Chargement des niveaux...</Text>
        </View>
      </View>
    );
  }
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      >
        <Text style={[styles.screenTitle, { color: theme.text }]}>Ma progression</Text>
          ...
          >
            <View style={styles.levelRow}>
              <View style={styles.levelLeft}>
                ...
                {entry.level.title && (
                  <Text style={[styles.levelTitle, { color: theme.text, opacity: 0.9 }]} numberOfLines={1}>
                    {entry.level.title}
                  </Text>
                )}
              </View>
        ...
        {userLevels.length === 0 && (
          <View style={styles.empty}>
            <Text style={[styles.emptyText, { color: theme.text }]}>Aucun niveau pour le moment.</Text>
          </View>
        )}
      </ScrollView>
    </View>
