...
export function HeaderDropdownMenu({
    ...
    const handlePrivacy = async () => {
        await WebBrowser.openBrowserAsync(
            "https://cashou.app/politique-confidentialite",
            {
                presentationStyle:
            ...
            [
                { text: "Annuler", style: "cancel" },
                {
                    ...
                    onPress: () => {
                        onClose();
                        Linking.openURL(
                            "mailto:contact@cashou.app?subject=Contact%20Cashou",
                        );
                    },
                },
            ],
        ...
        >
            ...
            <Text
                style={{
                    ...
                    fontFamily: "Roboto",
                    letterSpacing: 0.1,
                    color: item.destructive ? "#F44336" : colors.text,
                }}
            >
                {item.label}
            </Text>
