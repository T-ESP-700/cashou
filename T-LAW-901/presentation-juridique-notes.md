# Notes orateur — Présentation juridique Cashou

Contenu détaillé à dire pour chaque slide. La diapo affiche les titres, phrases courtes et **trois types d’écussons** à côté de chaque texte : **applicabilité** (Applicable / Partiel / Vigilance / Non applicable), **zone** (pays ou continent : UE, France, UE / France), **organisme** quand il y en a un (CNIL, AMF · ACPR, ANSSI).

---

## Slide 1 — Logo / Titre

**À l’écran :** Logo Cashou + « Cadre juridique et réglementaire applicable »

**À dire :**  
Présentation du cadre juridique et réglementaire qui s’applique à notre projet Cashou. On va rappeler ce qu’est l’app, puis passer en revue les textes et autorités concernés, avec pour chacun pourquoi ça s’applique ou non.
...
**À dire :**  
Cashou est un service de communication au public en ligne : site et app avec contenu édité. La LCEN, mise à jour par la loi SREN 2024, impose des mentions légales : dénomination sociale, forme juridique, siège, capital, RCS/SIRET, contact, directeur de publication, hébergeur, etc. L’objectif est que les utilisateurs et les autorités puissent identifier qui est responsable du service. Les mentions doivent être accessibles avant téléchargement — donc dans les descriptions des stores — et dans l’app, par exemple dans un menu « Mentions légales ».
...
**À dire :**  
NIS2 vise des secteurs d’importance vitale : énergie, transports, banque, santé, eau, infrastructures numériques critiques. Cashou est une plateforme éducative, pas un opérateur de ces secteurs, donc NIS2 ne s’applique pas. On peut en revanche vérifier que les hébergeurs ou fournisseurs cloud utilisés sont conformes si besoin.  
DORA s’applique aux entités du secteur financier — établissements de crédit, assurances, marchés. Cashou n’est pas une telle entité : c’est un outil pédagogique avec une simulation virtuelle. Le périmètre réglementaire vise les acteurs qui fournissent des services financiers régulés, pas les applications d’éducation financière.
